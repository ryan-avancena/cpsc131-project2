...
public:
    ...
    void switchToPrevTab() {
        ...
        std::cout << "(switchToPrev called)" << std::endl; 
        cursor->printTab(); 
    }
    ...
    void switchToNextTab() {
        ...
        std::cout << "(switchToNext called)" << std::endl;
        cursor->printTab(); 
    }
    ...
    void closeCurrentTab() {
        ...
        std::cout << "(closeCurrentTab called)" << std::endl;
        std::cout << "Closing : " << cursor->url << std::endl; 

        if (head == tail) { // case where there is one tab
            delete head;
            head = nullptr;
            tail = nullptr; 
            cursor = nullptr; 
        ...
        std::cout << "Current tab is now : " << cursor->name << " - " << cursor->url << std::endl; 
        std::cout << std::endl; 
    }
    ...
    void deleteTab() {
        ...
        std::cout << "Deleted Tab : " << del->url << " - "<< del->name << " ... " << del->memory << "MB/s" << std::endl; 
        std::cout << std::endl;
    ...
    /* NOT NEEDED */
    void showCurrent() {
        std::cout << "Current tab is now: " << cursor->url << std::endl; 
    }
};
